...
describe Pawn do
  ...
  context 'check correct rotation' do
    ...
    it 'return back to north from left' do
      expect(pawn.revolve_left).to eq(:west)
      expect(pawn.revolve_left).to eq(:south)
      expect(pawn.revolve_left).to eq(:east)
      expect(pawn.revolve_left).to eq(:north)
    end

    it 'return back to north from right' do
      expect(pawn.revolve_right).to eq(:east)
      expect(pawn.revolve_right).to eq(:south)
      expect(pawn.revolve_right).to eq(:west)
      expect(pawn.revolve_right).to eq(:north)
    end
  end
